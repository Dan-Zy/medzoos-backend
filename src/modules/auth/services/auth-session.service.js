...
async function listUserSessions(userId, currentRefreshToken) {
  return getUserSessions(userId, currentRefreshToken);
}

async function revokeUserSession(userId, sessionId) {
  return revokeSessionById(sessionId, userId);
}

async function revokeOtherUserSessions(userId, currentRefreshToken) {
  return revokeOtherSessions(userId, currentRefreshToken);
}
