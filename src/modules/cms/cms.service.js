...
const DEFAULT_SETTINGS = {
  ...
  contact_email: 'contact@medzoos.pk',
  support_email: 'support@medzoos.pk',
  help_email: 'help@medzoos.pk',
  accounts_email: 'accounts@medzoos.pk',
  security_email: 'security@medzoos.pk',
  hr_email: 'hr@medzoos.pk',
  verify_email: 'verify@medzoos.pk',
  sales_email: 'sales@medzoos.pk',
  feedback_email: 'feedback@medzoos.pk',
  info_email: 'info@medzoos.pk',
